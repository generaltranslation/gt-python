...
def _make_manager(translations_by_locale=None, **kwargs):
...
def test_target_locale_with_translation():
...
def test_target_locale_missing_translation():
...
def test_t_raises_without_init():
